...
(function($) {
    ...
    $.fn.bart = function( method ) {
       ...
       var locale = getLocale();
		...
		document.getElementById(balloon_index.toString().concat('_pumps')).value = pumps;
		document.getElementById(balloon_index.toString().concat('_explosion')).value = explosion;  		
		document.getElementById(balloon_index.toString().concat('_response_time')).value = response_time;
        ...
        return this.first().each(function() {
            ...
            var butInflate = $('<input>')
                ...
                .on('click.bart', function(e) {
                    ...
                    $("#".concat(balloon_index.toString()).concat("_submit_balloon")).click();
